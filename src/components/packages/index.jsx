...
import "./index.css";
import Package1Button from "../../assets/button_01.png";
import Package2 from "../../assets/button_02.png";
import Package3 from "../../assets/button_03.png";
import Package1 from "../../assets/1.png";
import Package2Button from "../../assets/2.png";
import Package3Button from "../../assets/3.png";
          ...
          <div className="package">
            ...
            <div className="des">
              <div>
                ...
                <div className="text">200$ to 999$ </div>
                <div className="text"> 8% to 14% per month</div>
                <div className="text">
                  total return 200% ( including capital )
                </div>
              </div>
